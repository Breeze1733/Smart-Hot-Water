...
_global.requirePlugin = _global.requirePlugin || function(name) {
    try {
        if (_modules["api/nb.js"]) return _customRequire("api/nb.js");
    } catch(e) {}
    return {};
};
...
if (typeof _global.App !== 'function') {
    _global.App = function(obj) {};
}
...
define("C2427CC194FC73BFA42414C6A277E8C0.js", function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, XMLHttpRequest, WebSocket, Reporter, webkit, WeixinJSCore) {
    ...
    module.exports = {
        ...
        onBLECharacteristicValueChange: function(e) {
            ...
            window._bleDataCb = function(bufferOrHex) {
                var buffer;
                if (typeof bufferOrHex === "string") {
                    var cleanHex = bufferOrHex.trim();
                    var len = cleanHex.length;
                    var view = new Uint8Array(len / 2);
                    for (var i = 0; i < len; i += 2) {
                        view[i / 2] = parseInt(cleanHex.substr(i, 2), 16);
                    }
                    buffer = view.buffer;
                } else if (bufferOrHex && bufferOrHex.buffer) {
                    buffer = bufferOrHex.buffer;
                } else {
                    buffer = bufferOrHex;
                }
                if (e) e({ value: buffer });
        ...
        writeBLECharacteristicValue: function(e) {
            ...
            if (NativeBle.write) {
                var hexStr = Array.prototype.map.call(new Uint8Array(e.value), function(b) {
                    return ("00" + b.toString(16)).slice(-2);
                }).join("");
                try { NativeBle.write(JSON.stringify({ value: hexStr })); } catch(err) {}
            }
...
define("waterManager.js", function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, XMLHttpRequest, WebSocket, Reporter, webkit, WeixinJSCore) {
    "use strict";
    var n = require("3CFBD57594FC73BF5A9DBD72A447E8C0.js");
    ...
    function switchWater(isOpen, macNumber) {
        ...
        n.switching(actionName, callback, "ble", false);
    }
